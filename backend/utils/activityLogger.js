...
export const logApplicationUpdated = async (userId, applicationId, entityName, oldData, newData) => {
  const changes = [];
  const changedFields = [];
  
  // Compare fields
  const fieldsToTrack = ['status', 'company', 'role', 'notes', 'source', 'salaryRange'];
...
export const logApplicationDeleted = async (userId, applicationId, entityName) => {
